...
//         lockTime[_userAddress] = block.timestamp + 1 days;
//     }

//     // <<<<<< Deploy edilen kontratın sahibini değiştirmk için kullanılan fonksiyon >>>>>> \\
...
//     // <<<<< nft oluşturmak için kullanılan fonksiyon, bu fonk. ile elindeki tüm itemleri yakıyoruz >>>>> \\
